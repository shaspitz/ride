...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/smarshall-spitzbart/ride/ride/params
   */
   ...
   *
   * @tags Query
   * @name QueryStoredRideAll
   * @summary Queries a list of StoredRide items.
   * @request GET:/smarshall-spitzbart/ride/ride/stored_ride
   */
  queryStoredRideAll = (
    query?: {
    ...
    this.request<RideQueryAllStoredRideResponse, RpcStatus>({
      path: `/smarshall-spitzbart/ride/ride/stored_ride`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryStoredRide
   * @summary Queries a StoredRide by index.
   * @request GET:/smarshall-spitzbart/ride/ride/stored_ride/{index}
   */
  queryStoredRide = (index: string, params: RequestParams = {}) =>
    this.request<RideQueryGetStoredRideResponse, RpcStatus>({
      path: `/smarshall-spitzbart/ride/ride/stored_ride/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
